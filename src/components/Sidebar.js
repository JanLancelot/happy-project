...
const navigation = [
  ...
  { name: "Clearances", href: "#", icon: DocumentDuplicateIcon, current: false },
  { name: "Disciplinary Records", href: "#", icon: AcademicCapIcon, current: false },
...
const teams = [
  ...
  { id: 4, name: "Property Custodian", href: "#", initial: "P", current: false },
  ...
  { id: 9, name: "Student Org (SSITE)", href: "#", initial: "S", current: false },
  { id: 10, name: "Student Council (SSC)", href: "#", initial: "C", current: false },
];
...
export default function Sidebar({ children }) {
  ...
  const filteredNavigation = userRole === "faculty" ? [{ name: "Manage Requirements", href: "#", icon: CogIcon, current: true }] : navigation;
                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                    <div className="flex h-16 shrink-0 items-center">
                      <img className="h-10 w-auto" src="https://dyci.edu.ph/img/DYCI.png" alt="DYCI Logo" />
                    </div>
                      ...
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li>
                          ...
                          <ul role="list" className="-mx-2 mt-2 space-y-1">
                            {teams.map((team) => (
                              <li key={team.name}>
                                <a href={team.href} className={classNames(team.current ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:text-indigo-600 hover:bg-gray-50", "group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold")}>
              ...
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li className="-mx-6 mt-auto">
                  <a href="#" className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-50">
                    <img className="h-8 w-8 rounded-full bg-gray-50" src="https://scontent.fcrk3-2.fna.fbcdn.net/v/t39.30808-6/434160685_3684034858582066_7920754165546455039_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeGhBHbIAGejJ9X4kVIO8GJ_E7K8DJZKydYTsrwMlkrJ1okJf462xxpn1XdWPFBCtGI_UNMDSsljXOBo0iVVH51B&_nc_ohc=gTd2lOAtIMQQ7kNvgHc96QU&_nc_ht=scontent.fcrk3-2.fna&oh=00_AYABD6tOJ6q3oEMHpbOR1ypGoVLs9klEQEGaXXiM4ubxFQ&oe=6662D828" alt="" />
