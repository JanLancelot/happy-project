...
function TeachersPage() {
  ...
  return (
    <div>
      ...
      <Link to="/create-teacher" className="bg-blue-500 text-white p-2 rounded hover:bg-blue-700">
        Add Teacher
      </Link>
      <div className="my-4">
        <label htmlFor="level" className="block text-gray-700">Filter by Level</label>
        <select
          id="level"
          value={selectedLevel}
